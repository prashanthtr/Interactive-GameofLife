               ...
               return function(scale_w, scale_h, side_w, side_h ){
                   ...
                   gol.sense = function( n, workspace ){
                       ...
                       for( var figs =0; figs< workspace.length; figs++ ){
                           ...
                           var row1 = xy1[1]/gol.scale_x
                           var col1 = xy1[0]/gol.scale_y
                           var row2 = xy2[1]/gol.scale_x
                           var col2 = xy2[0]/gol.scale_y
                           ...
                           gol.cells[col1][row1].state = 0; utils.setColor(gol.cells[row1][col1]);
                           gol.cells[left1][row1].state = 0; utils.setColor(gol.cells[row1][col1]);
                           gol.cells[right1][row1].state = 0; utils.setColor(gol.cells[row1][right1]);
